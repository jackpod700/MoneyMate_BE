package com.konkuk.moneymate.common.templates.$page$ai.service;
...
@Service
@Slf4j
public class AgentTemplateService2 {
    // ##### 필드 #####
    ...
    // ##### 생성자 #####
    public AgentTemplateService2(ChatClient.Builder chatClientBuilder) {
