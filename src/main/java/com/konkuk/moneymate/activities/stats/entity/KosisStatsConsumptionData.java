package com.konkuk.moneymate.activities.stats.entity;
...
/**
 * <h3>ConsumptionStats (tb: stats_consumption)</h3>
...
@Getter
@Entity
@Table(name="stats_data_consumption")
public class KosisStatsConsumptionData {
