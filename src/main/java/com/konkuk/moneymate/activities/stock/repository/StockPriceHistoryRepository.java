package com.konkuk.moneymate.activities.stock.repository; // repository 패키지는 알맞게 수정해주세요.

import java.math.BigDecimal;
import java.time.LocalDate;
import java.util.List;

import com.konkuk.moneymate.activities.stock.entity.StockPriceHistory;
import com.konkuk.moneymate.activities.stock.dto.StockPriceHistoryId;
